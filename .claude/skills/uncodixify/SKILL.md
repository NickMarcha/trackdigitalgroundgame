---
name: uncodixify
description: Build normal, human-designed UI. Bans default AI aesthetics (gradients, glass panels, eyebrow labels, pill shapes, oversized radii, hero sections in dashboards). Use when writing any HTML/CSS/UI code.
---
